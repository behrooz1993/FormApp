...
import com.ahmadpour.formapp.data.db.models.CodesDao;
...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig codesDaoConfig;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        codesDaoConfig = daoConfigMap.get(CodesDao.class).clone();
        codesDaoConfig.initIdentityScope(type);
        ...
        codesDao = new CodesDao(codesDaoConfig, this);
        ...
        registerDao(Codes.class, codesDao);
    }
    ...
    public void clear() {
        ...
        codesDaoConfig.clearIdentityScope();
    }
